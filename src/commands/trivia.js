...
exports["default"] = (function (message, args, client) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        message["delete"]();
        request_1["default"]("http://numbersapi.com/" + args[0], function (error, response, body) {
            message.channel.send(embed_1["default"]("/ Trival " + args[0] + " /", author_1["default"], body, 0x03A9F4), new discord_buttons_1.MessageButton()
                .setEmoji("⛔")
                .setLabel("Close")
                .setID("close")
                .setStyle("red"));
